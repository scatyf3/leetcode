...
| 性质 | 连续版 | 可跳版 |
|---|---|---|
| 回文 | **LC 5** 最长回文子串 / **LC 647** 回文子串计数 | **516** 最长回文子序列 |
| 递增 | **674** 最长连续递增序列 | **LC 300** 最长上升子序列 |
| 公共 | **718** 最长重复子数组 | **1143** 最长公共子序列 |
| 和/积 | **209** 最短子数组 / **LC 152** 最大乘积子数组 | 背包类(494 等) |
...
所以 LC 128 既不是滑窗也不是 DP,而是哈希集合。**别看到 consecutive 就以为是连续区间。**
